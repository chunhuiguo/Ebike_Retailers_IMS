...
/**
 * ProductHistory entity. @author MyEclipse Persistence Tools
 */
...
public class ProductHistory implements java.io.Serializable {
	...
	/** minimal constructor */
	public ProductHistory(String productBarcode) {
		this.productBarcode = productBarcode;
	}

	/** full constructor */
	public ProductHistory(String productBarcode, String productCode,
