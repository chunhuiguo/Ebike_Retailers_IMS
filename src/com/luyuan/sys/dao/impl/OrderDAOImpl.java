/**
 * @(#)OrderDAOImpl.java  1.0 10/05/12
 *
...
/**
 * 
 * 最终会被注入的OrderDAO，实现DAO接口逻辑
 *
 * @see com.luyuan.sys.entity.Order
 * @author gch
 */

public class OrderDAOImpl extends HibernateDaoSupport implements OrderDAO {	
	
	public List<Order> findByShipOrderId(Object shipOrderId) {		
		return this.findByProperty("shipOrderId", shipOrderId);
	}
	
	//************************************************************************
	private List<Order> findByProperty(String propertyName, Object value) {
