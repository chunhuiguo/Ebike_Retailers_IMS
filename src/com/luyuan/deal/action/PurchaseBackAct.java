/**
 * @(#)PurchaseBackAct.java  1.0 10/05/03
 *
...
/**
 * 
 * 进货退货单PurchaseBack的表现层action
 *
 * @author gch
 */

public class PurchaseBackAct extends VoucherAct {
	 ...
	 */
	public String input() {
		voucher = this.getInitVoucher( type + "进货退货单" );
...
//			this.addFieldError("voucher.checkDate", "日期格式不正确(参考：2011-01-23)");
		...
		if( voucher.getSubAccountId() == null ) 
			this.addFieldError("voucher.subAccount", "账户不能为空，请重新选择收货单位来填充账户信息");
