...
public class LossAct extends VoucherAct {
	 ...
	 */
	public String input() {
		voucher = this.getInitVoucher( type + "报损单" );
...
//	public String print()			{	return "print";				}
	...
	private void validateVoucher(){
		if( voucher.getCheckDate().trim().equals("") ) 
			this.addFieldError("voucher.checkDate", "报损日期不能为空");
...
//			this.addFieldError("voucher.checkDate", "日期格式不正确(参考：2011-01-23)");
		...
		if( voucher.getWarehouseId() == null ) 
			this.addFieldError("voucher.warehouse", "出库仓库不能为空");		
	}
