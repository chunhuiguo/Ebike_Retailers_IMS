...
<body>
<div class="container">	     	  
	  <form action="/info/pPriceList.html" method="post">
	  <s:token/>
	    <div class="chithead"> 
	    <table>
	    <tr>
	    <td>
	    <p class="title">配件价格管理——配件价格查询</p>
	    </td>
	    </tr>							
		<tr>
		...
		<td>		
			<input type="submit" id="submit" name="submit" value="选择配件" />
		</td></tr>
		</table>					
	    </div>		
				<table class="chitdetail" >
				 ...
				 <span class="errors">${errors['pprice.price'][0]}</span>
