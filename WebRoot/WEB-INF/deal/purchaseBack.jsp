...
<html>
	<head>
		...
		<script type="text/javascript" src="/js/deal/purchaseBack.js"></script>
	...
	<body>
		<div class="container">			
			...
			<form action=<c:if test="${type eq '整车'}">"/deal/purchaseBack.html"</c:if>
						<c:if test="${type eq '配件'}">"/deal/ppurchaseBack.html"</c:if> method="post">
				<s:token/>
				
				<div class="chithead"> 
					<p class="title">${type}进货退货单</p>					
					<div class="right">
