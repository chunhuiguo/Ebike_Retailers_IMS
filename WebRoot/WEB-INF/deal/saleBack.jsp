...
<html>
	<head>
		...
		<script type="text/javascript" src="/js/deal/saleBack.js"></script>
	...
	<body>
		<div class="container">			
			...
			<form action=<c:if test="${type eq '整车'}">"/deal/saleBack.html"</c:if>
						<c:if test="${type eq '配件'}">"/deal/psaleBack.html"</c:if> method="post">
				<s:token/>
				
				<div class="chithead"> 
					<p class="title">${type}销售退货单</p>					
					<div class="right">
				...
				<table class="chitbody" cellspacing="4">
					...
					<tr><td>						
						...
						<input type="submit" name="method:unitList" value="选择退货单位" <c:if test="${checked}">disabled</c:if> />	
